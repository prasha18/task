            ...
            <form action="<?php echo $licanse_update;?>" method="post">
              <?php if(isset($_SESSION['licanse_error']) &&  $_SESSION['licanse_error'] == true){ ?>
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" required name="license_key" class="form-control" value="<?php echo $license_code;?>" placeholder="enter your purches/license code">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-4 col-form-label">Your email</label>
                  <div class="col-sm-8">
                    <input type="email" required name="email" class="form-control" value="" placeholder="enter your email">
                  </div>
                </div>
                <div class="form-group">
                  <div class="float-right">
