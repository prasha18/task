...
function mailsend($mail,$username,$password){
  ...
  $message .= "<h3>Thank you for installing bulk email verifier. Here's your access</h3>";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['configuration'])) {
          ...
          $client_name = null;
          if("1" != "0") {
            $license_code = "0"; $client_name = "sdhamija1997@gmail.com";
          /*
          ...
          */
          ...
          $responseObj->license_title = "Premium";
          $responseObj->license_key = "SAHIL04111997";
          $responseObj->msg = "Authenticated Successfully";
...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Bulk Email Verifier - Installation</title>
  ...
  <body>
    <noscript>
      <div class="js_stop">
		  	...
		  	We're sorry, but 'Bulk Email Verifier' doesn't work without JavaScript enabled. If you can't enable JavaScript in this browser then try a different browser which support JavaScript.
		  </div>
  ...
  <footer class="footer-area text-center">
    <p>Copyright @ 2023 - Bulk Email Verifier</p>
  </footer>
  <?php if($action==1){?>
